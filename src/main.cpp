...
genSubscriber sub_int;
genSubscriber sub_bool;
genSubscriber sub_double;
...
void setup() {
  ...
  // sub_bool.init(&node, "BooleanSub", &executor, &BooleanCallback, BOOL);
  // sub_int.init(&node, "Int32Sub", &executor, &Int32Callback, INT);
  // sub_double.init(&node, "DoubleSub", &executor, &DoubleCallback, DOUBLE);
